...
## Entry — 2026-07-10 EVE — user asked: SNDK and SKHY buys at current time? (view stated, user-gated)
**SNDK: NO at current time — P~65 (my model) that SNDK-entered-now underperforms SKHY-entered-now over 6 months.** Basis: NAND GM at ceiling with QoQ delta collapsed (78.4%→79-81% guide, +1-3pp; per `signals/cross-source-log/2026-07-10-gitlab-deepdive-3agent-sndk-pretask.md`); HBF kicker real but sampling-stage 2027+; +635% YTD capitalizes the peaking leg; regret-chase discipline applied against our own pending exit-miss grade. Falsifier/update triggers: Aug-5 beat + HBF volume date → re-examine with data.
**SKHY: qualified YES = the pre-registered one-company pick (P~60, locked 2026-07-09) with entry structure:** not before Mon Jul-13 tape (anti-debut-chase binding); premium gate ≤~5% over ordinary (10:1 ratio, live FX; $158-equiv ≈ 9% = no); STAGED (half post-Jul-13/16 gauntlet, half post SKH late-Jul GM print); **Active tier 3-8%, NOT Core** — joint-state cap: book already ~38% upstream memory-cycle (MURATA+SUMCO); GM-crack scenario hits memory-maker equity harder than LTA-floored wafers. Rule #18 bear stated (consensus-late into crowding N=4) — answered by thin premium (+2.5-2.9% at pricing, verified) + staging + Active cap, not dismissed.
**Resolution:** grade both legs at 2027-01-14 alongside the one-company pick (same horizon); interim checkpoint at SKH late-Jul print. NO ACTION until user calls it. 🟡

## UPDATE 2026-07-10 NIGHT — SKHY view EXECUTED BY USER (WI line, ahead of both gates)
User bought 37 SKHYV @ $173.45 Fri 18:44 (before Jul-13 tape; premium +19.7% vs ordinary computed = above my ≤5% gate; size 6.0% = within my Active 3-8% band). His stated rationale = STRUCTURAL-branch insurance (zero direct memory felt "reckless"; inference early-innings, memory-dependent) — a coherent regret-minimization/anti-fragility argument that ACCEPTS paying premium for the H3 branch. GRADING NOW TRACKS THREE THINGS: (1) the one-company pick itself (2027-01-14), (2) my ≤5% premium gate vs his override — resolves via premium path post-Jul-13 (if premium compresses ≥10pp, gate was right; if persists/widens, override was right), (3) structural-vs-cyclical hypothesis via the GP-bridge sign test (SKH late-Jul print = first read). Position home: `companies/SKHY/thesis.md`.
