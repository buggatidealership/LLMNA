...
|---|---|---|---|---|---|
| **2026-08-04** | **2026-08-05** (FSC single-stock leveraged-ETF rules take effect) | KR ETF-divergence hypothesis | Reading #1 (08-03) gave lev-ETF underlyings **−2.09pp** vs non-ETF Hanmi; reading #2 (08-04) gave **+2.09pp** — same magnitude, opposite sign, which is what plain beta produces. Call: the 08-05 rule-effective date is the adjudicating session; a spread that persists **after** the mechanical-selling channel closes is not mechanical selling. | **⚠️ NO P STATED AT BOOKING** — the 08-04 artifact hedged in prose (*"equally consistent with plain beta"*) without ever writing a number. Recorded as-is rather than back-filled. **This is the first thing the convention catches: an unfalsifiable hedge reads as caution and grades as nothing.** | pending | **⚠️ 2026-08-07: OVERDUE. The re-spec-or-retire decision was due 2026-08-06 and did not happen. This is the row the 08-05 reading could not adjudicate (all branches on one side — L54). It is now carrying a second day past its own deadline; either re-spec the test or retire it, but it must not keep rolling.**
| ~~2026-08-05~~ **✅ GRADED 2026-08-06** | **2026-08-06** (report is **PRE-MARKET**; reaction = 08-06 close vs 08-05 close) | **DDOG Q2 2026 — full print + reaction** | **R-1** revenue > $1,078.575m **P=0.87** (point **$1,118m**) · **R-2** non-GAAP EPS > $0.583 **P=0.90** (point **$0.65**) · **R-3** FY2026 guide RAISED above $4.34bn **P=0.93** (point ~$4.53bn) · **R-4** same-day direction **UP P=0.55** · **R-5** \|move\| ≥10% **P=0.60** (point **+3%**). **REVISION #1 same day, pre-print: R-4 FLIPPED from DOWN 0.58 to UP 0.55.** Original chain was *bar at all-time high ⇒ beat compresses ⇒ sub-3.2% beats react −6.2% ⇒ DOWN*. The T1 Q2 guide ($1.07–1.08B) showed consensus is **99.87% of the guide TOP** — the record bar is **management's, not the street's**, and the correct instrument is the **guide-relative** beat (+4.06%, +4.72% last two quarters), which implies a NORMAL ~+3.6% beat. Structural finding: **reaction correlates with BEAT MAGNITUDE at +0.736**, vs run-in +0.254 and bar-height −0.162. | `(my model)` — R-1 anchored on **BR-1 program prior 82.8% robust** (DDOG not in the BR-1 row sample, parent class binds) lifted for a 13/13 own record and the guide-relative series; R-5 cross-checked against an **options-implied ~±13%** (T2) and historical mean \|move\| 11.95%. **Ensemble N=3: 2 UP / 1 DOWN, numeric legs converged within 0.4%** — direction spread reported, P unchanged (Program v2). **B45 flagged: last three reactions were +31.3%/+13.7%/+23.1% and my documented failure is under-calling upside.** | GRADED 2026-08-06 | **✅ GRADED 2026-08-06 — R-1/R-2/R-3/R-5 HIT, R-4 declared NO-CALL, 🔴 O-3 MISS (weakens L57 by its own pre-registered test). Artifact: `signals/cross-source-log/2026-08-06-thu-eod-two-predictions-resolve-and-the-lesson-is-that-i-was-right-for-a-reason-that-did-not-happen.md`. 🔴 ROW WAS LEFT `pending` FOR 1 DAY AFTER GRADING — caught by the 08-07 EOD sweep, same class as the 07-23 row that sat 10 days.**
| ~~2026-08-05~~ **✅ GRADED 2026-08-06** | **2026-08-06** (T+1 close after the 08-05 13:30 PT print) | **SNDK Q4 FY26 reaction leg** | **R-1** both lines beat consensus **P=70%** · **R-2** \|T+1\| ≥10% **P=60%** · **R-3** direction NEGATIVE **P=52/48 — registered as a coin flip** · **R-4** beat-then-negative (the Kioxia shape) **P=35%** · **R-3a ADDED 2026-08-05 ~08:5xZ: after-hours 08-05 direction** — the clean earnings-attribution window, added after operator pushback; a same-window catalyst now triggers DECOMPOSITION, not suspension. **REVISED ~09:3xZ (still pre-print) — R-3 0.52→0.64, R-4 0.35→0.39** on AMD's 08-04 beat-and-fall, making N=3 in 6 days (MPWR 07-30, Kioxia 07-31, AMD 08-04). Decomposition also caught that the original R-3/R-4 were MUTUALLY INCONSISTENT (implied P(neg|miss)=0.57, not credible); rebuilt from conditionals P(neg|miss)=0.85, P(neg|beat)=0.55. R-1/R-2 unchanged. **I moved from LOWEST of four (0.52 vs ensemble 0.583) to HIGHEST (0.64).** Structural claim: **the GUIDE decides, not the quarter** — last qtr beat its guide midpoint **1.80×**. | `(my model)` — R-1 from the 1.80× guide-beat history + Samsung NAND ASP +high-60s% (T1 07-30); R-2 from implied 12–15.62% vs 4-of-5 exceeded; R-3/R-4 no external base rate, judgement only. **B45 noted: I am resisting a larger negative tilt because under-calling upside is my documented failure mode.** | GRADED 2026-08-06 | **✅ GRADED 2026-08-06 — R-1 HIT · R-2 MISS (−8.00% on the REGISTERED 08-05 basis; the 08-04 basis would have made it a HIT and was NOT used) · R-3 HIT · R-4 HIT (the non-consensus leg) · R-3a HIT. Produced L59, AMENDED 2026-08-07: the leg carried SIX registered premises and the grade scored all of them on the one that failed. Artifact: same 08-06 EOD file. 🔴 ROW WAS LEFT `pending` FOR 1 DAY AFTER GRADING.**
| **2026-08-04** | rolling — recheck by **2026-08-11** | EODHD index `previousClose` defect | Called **intermittent, not permanent** (clean on 08-03, sign-inverting on 08-04). The call: it recurs at least once more within 7 sessions, and single-stock `previousClose` stays clean while INDEX symbols do not. | `(my model)` — N=3 observations, no external base rate exists for a vendor field defect. Directional, not numeric. | pending | **UPDATE 2026-08-07: INSTANCE 6 — index-only T-2 `previousClose` (both indices returned the 08-05 close on an 08-07 fetch); all four single-stock prevCloses clean. The "intermittent, not permanent" call now stands at 6 observed instances. Recheck deadline 2026-08-11 UNCHANGED and now 4 days out.**
...
|---|---|---|---|---|
| 2026-07-22 | **✅ FULLY GRADED — slate CLOSED 2026-07-25.** Print legs 2026-07-22 (9/9 directional, Brier 0.1018) + **T+24h legs I-5/N-5 graded 2026-07-25, 2 sessions late** (I-5 TRUE +0.43%; N-5 FALSE −3.69%; two-vendor settled closes). **Full 11-leg slate: Brier 0.1344, 10/11 directional.** ⚠️ Grade-time tape CORRECTION issued: "IBM −25%" was the 07-14 pre-warning crash misattributed into the print frame (actual print reaction +0.43%); "NOW +3.7% AH" reversed to −3.69%; GOOGL −5% AH → actual −7.13%. Finding: **4 of 5 cohort names had reaction sign INVERT vs print content** = Principle #48/#49 capex-flip reflexivity now measured, not inferred. L42 candidate. See `signals/cross-source-log/2026-07-25-fri-eod-reaction-leg-grade-legb-kr-etf-crackdown.md` | IBM + NOW + GOOGL | Q2 twin-print + capex binary — 9 print-legs graded (8 TRUE + N-4 correct-FALSE-lean; G-1 capex RAISED $195-205B TRUE; L33 SPLIT = hardware-displacement not software-squeeze). See GRADE section in file | `2026-07-22-IBM-NOW-GOOGL-twin-print-registrations.md` |
...
| ~~2026-07-07~~ | ~~2026-07-23~~ **✅ GRADED 2026-08-02 (10 days late — found by the EOD grade sweep, not by the parser, which had been listing it beside two already-graded rows). VERDICT: relative call HIT, absolute call HIGH, and the ASP test itself was INSTRUMENT-INVALID.** OP actual ₩89.49tn vs our unrevised ₩92tn point = **−2.73%** (₩2.51tn high). Pre-registered beat-magnitude band **+4.45% to +5.7%** vs computed actual **+4.56% to +5.78%** across the three anchors (2nd panel ₩84.6tn → +5.78%; FnGuide ₩84.98tn → +5.31%; updated bar ₩85.59tn → +4.56%) — **band HIT, top edge overshot by 0.08pt.** Revenue ₩171.5tn vs panel ₩173.0tn = **−0.87% MISS**. (c) >₩100tn ex-provision wire claims **FALSE** on the reported line. (a) three-way ASP adjudication — **see L54: the test had no branch for the outcome that occurred.** Full 3-layer grade in `predictions/lessons.md` 2026-08-02. | CARRY-OVER components from the prelim grade: (a) three-way Q2 blended-DRAM-ASP dispute adjudication (>~63% QoQ test — needs division split); (b) guidance-language component; (c) division-level OP vs the ex-provision >₩100tn wire claims. **PANEL PIN (07-07 user disclosure-card relay): second consensus panel rev ₩173.0tn / OP ₩84.6tn — vs our carried FnGuide ₩84.98tn (07-01) and updated bar ₩85.59tn (07-06); beat magnitude +4.45% to +5.7% depending on panel — state BOTH at full-print grade** | `2026-07-02-SAMSUNG-Q2-prelim-prediction.md` (carry-over section) |
...
| 2026-07-02 | ~~2026-07-29~~ | ~~SK Hynix~~ **✅ GRADED 2026-07-29 (fundamental T+0; T+24h reaction due 07-30 w/ FOMC+CXMT confound decomposition) — see `signals/cross-source-log/2026-07-29-wed-kr-open-wake-print-day.md` §2.3-2.6 + lessons.md L46 entry** | ~~rev pt ₩88tn / OP pt ₩68tn / P(beat)~75%~~ **GRADED: rev ₩79.32T = −9.9% below point / OP ₩60.54T = −11.0% below point (computed); beat-call WRONG on every consensus basis (−3.90% to −5.53% OP); 2027-HBM leg NEUTRAL (no explicit 2027 pricing language in release; HBM4 ramp + demand-exceeds-supply qualitative). Primary layer: INPUT (TrendForce 06-01/06-02 — pre-registration — already documented declining HBM contract prices + SKH's highest-HBM-mix ASP constraint; absent from the registration). Secondary: COMPUTATION (point implied +67.4% QoQ vs actual +50.9%; no mix-weighted tier blend). L46 candidate booked** | `2026-07-02-SKHYNIX-Q2-earnings-prediction.md` |
| 2026-07-02 | 2026-07-31 | Murata (HELD) | Q1 FY27: rev pt ¥505bn / OP pt ¥105bn (price-hike quarter front-load) / P(FY-raise)~25%; v2 T-5d | **GRADED 2026-07-31: numbers HIT (rev ¥502.264bn −0.54%, OP ¥98.454bn in-band, NI ¥81.377bn +3.01%), falsifier #1 did NOT fire — but MECHANISM WRONG on 3 of 3 causal legs (T1 短信 names product-price DECLINES as a headwind; auto +16.1% not negative; guidance RAISED vs our P=25%). L50 candidate: grade the mechanism separately from the number.** | `2026-07-02-MURATA-Q1FY27-earnings-prediction.md` |
...
| 2026-07-02 | ~~2026-08-07~~ **✅ GRADED 2026-08-04 (printed 2026-07-31, 4d before the logged date — the date itself was wrong, booked 07-31). REVENUE: actual ¥1,767.1bn vs our point ¥1,250bn = −29.3%; band ceiling ¥1,350bn missed entirely (actual 1.31× ceiling). **The company's own guide ¥1,750bn was accurate to +1.0% — and our file discarded it as implausible → L55.** **The ¥874.1bn 'consensus' in our file was REFUTED — a net-income figure crossed against an OP guide; real consensus OP ~¥1,370bn, ABOVE guidance, and Kioxia MISSED every street line (rev −3.96%, OP −4.68% GAAP ex-litigation, net −13.52%) → L56.** Both falsifiers dead: #1 unfireable by construction (actual 1.61× trigger), #2 not fired. REACTION LEG SUSPENDED — base ¥46,500 (07-31 close; TSE closes 15:30 = print time), T+24h **+5.72%**, T+48h **+12.02%**, but the stock FELL in PTS on the numbers and the move is ¥800bn-buyback + 3:1-split driven, not results-driven. 3-layer: INPUT catastrophic, COMPUTATION sound-given-inputs, REASONING downstream. See `lessons.md` 2026-08-04.** | Kioxia (HELD) | Q1 FY27: rev pt ¥1.25tn / OP pt ¥600bn / NI pt ~¥460bn | `2026-07-02-KIOXIA-Q1FY27-earnings-prediction.md` |
...
**2026-07-31 — BE FY2026 guidance prediction GRADED** (registered 2026-07-01, resolved at the 07-28 print): DIRECTION ✅ raise delivered; GM ✅ 34.3% in-band with the 2/5 minority judges correct; MAGNITUDE ❌ on every line, all low — Q2 rev $1,065.4m vs our $800m point (1.33×), and our band ceiling was the actual floor on both guide lines. Reaction leg SUSPENDED (L52 candidate). See `predictions/lessons.md` 2026-07-31.
