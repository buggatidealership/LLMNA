...
**2026-07-12 — Kwak (SKH CEO) T1 datum (TC-1 N+1):** Reuters exclusive Jul-10 — 2027 = worst supply year in industry history; demand > supply BEYOND 2030; HBM/DRAM subject (NAND not the subject); customers locking long-term contracts. GM-ceiling marker context: pure supply-side scarcity language from the #1 maker = consistent with CLIMBING phase (marker fires on blended-reported GM 85-90% then roll — unchanged). Incentive flag carried. Per `cross-source-log/2026-07-12-sun-eve-ai-brief-routing.md`.

**2026-07-12 — Kwak-claim pre-registered observables (block F run; grade against these, not rhetoric):** (1) 4Q26 server-DRAM contract print ~Jan-27: <+8% QoQ = weakening / ≥+10% = confirming; (2) spot-vs-contract sign flip before mid-2027 = 2018 signature = refutation; (3) CXMT realized ramp + pricing posture 2027 = swing variable for the 2030 tail; (4) LTA floor/prepay integrity through 2027 — any walk-back = revealed-preference reversal (also TC-18 falsifier); (5) SKH HBM wafer share realized ~40% vs stall ~30%. Per `cross-source-log/2026-07-12-sun-eve-kwak-substance-validation-blockF.md`.
