...
| **TC-4** Anthropic enterprise-trust drift | model-and-foundation-lab | [ACTIVE] | 12 — drift CONFIRMED by Anthropic walkback (admission = drift-confirmation, not drift-reversal) | (12) 2026-06-15 cascade: Anthropic reverses silent model changes policy after backlash per Reddit/ML + WIRED T2 — verbatim "We made the wrong tradeoff and we apologize for not getting the balance right" on silent nerfing of Claude Fable 5 safeguards. **Partial-walkback nuance:** Anthropic acknowledging the mistake CONFIRMS the drift happened; does NOT reverse the 11 prior instances of trust-drift. SELF-BIAS FLAGGED: as Fable 5 vendor, read as if OpenAI/Google walkback — strengthens triangulation. Prior: (6) Anthropic Cowork for Claude Desktop product expansion 2026-06-12 EVE; (7) Goose open-source Claude Code alternative competitive pressure 2026-06-12 EVE; (8) AWS multi-GW Trainium with Anthropic as ANCHOR CUSTOMER per SemiAnalysis T2 2026-06-12 EVE = compute-consumption-real leg + cross-cluster link to MRVL custom-Si bull case. Prior 5 signals 2026-06-11/12 AM. Verification-gate on independent benchmark still binding 2026-06-25 | 2026-06-15 cascade |
...
| **TC-10** Model-layer sovereignty + export control (+ competitive-capture sub-dimension + security-incident sub-dimension) | sovereign-AI / regulatory | **[ACTIVE]** | **8 in <96h** | **NEW SUB-DIMENSION 2026-06-15 (deferred-cascade from 2026-06-14 evening brief): security-incident vector.** Per Semafor T2 + Reuters T2: White House export restrictions on Anthropic's Mythos partly driven by fears China-linked group accessed the frontier model; Anthropic-WH meeting scheduled. Adds **H_d genuine-security / China-leak-driven (P~30% my model)** to prior H_a Amazon-incidental (45%→30%) + H_b regulatory-machinery (40%→30%) + H_c coordinated-intent (15%→10%). EU sovereignty push (Register T2) = exogenous accelerant. Prior TC-10 reads: suspension trigger named — Amazon CEO Jassy discussions + Amazon researchers' jailbreak demo (WSJ/Verge/Times of India T2). Both mechanisms (competitive-capture + security-incident) operate simultaneously. Raises regulatory overhang on ALL frontier labs (OpenAI state-AG probe same evening). Bypass route for HBM/frontier-lab exposure = sovereign-AI alternative providers (EU cluster CAP.PA / DTE.DE / OVH.PA / REY.MI / SU.PA / BE + JP/IN candidates). H2 structural-regime still MODAL. Per `signals/cross-source-log/2026-06-15-evening-brief-2026-06-14-cascade-tc10-tc4-eu-sovereignty-b40-verifications.md` | 2026-06-15 cascade |
