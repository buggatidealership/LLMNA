...
| **TC-3** DC-ceiling + EM-migration | power-and-cooling | [ACTIVE] | 8 — gigawatt-cluster sub-tier (xAI Colossus 2 = first 1GW coherent) | xAI Colossus 2 Memphis 1GW 122-day build per SemiAnalysis T2 2026-06-12 EVE = empirical Layer-3 power-binding at frontier; rack-unit framing obsolete, new TAM unit = gigawatt-coherent-cluster. Prior: AI 600B gal water 2030 + Amazon 2.5B gal | 2026-06-12 evening brief Workflow #9 |
...
| **TC-10** Model-layer sovereignty + export control | sovereign-AI / regulatory | **[ACTIVE]** | **6 in <72h** | **PROMOTED CANDIDATE → ACTIVE 2026-06-13 AM:** Anthropic shutdown executed + Reuters "US-only deployment" formal market-segmentation retreat (morning brief #1+#6+#14) on top of yesterday's directive + Mistral + DoW + NVDA China stack. H2 (structural regime) NOW MODAL P~55% (was 40%); H1 (transient) collapsed to P~15% on operationalization framing; H3 (broad sustained) P~30%. Investable expression gap still: EU-sovereign-AI infra no held/watchlist name captures (research gap 2026-06-25 supply-chain cycle elevated urgency). | 2026-06-13 morning brief |
