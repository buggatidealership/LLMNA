...
| **TC-5** CoPoS / glass-core packaging firming | advanced-packaging | [ACTIVE] | **7 — 2-subagent verification of ETNews 2026-06-15** | **TSMC PLP = TSMC CoPoS confirmed (same VisEra pilot, same AP7 fab); Subagent B independently verified 6 NEW T1 datapoints: Camtek Golden Eagle 600-650mm PLP-rated; BESI Q1 2026 orders doubled YoY + die-attach 80% revenue + hybrid bonding EUR 476M FY26; NEG TGV native-jp T1 follow-on; Absolics/SKC AMD+AWS named customers + 1.2T won raise; ASE-TSMC June 2025 PLP co-dev agreement + ASE 310mm line MP H1 2027 = explicit TSMC overflow handler; IBIDEN ¥500B FY26-28 capex reinforced (FC-BGA organic; glass-core MEDIUM-TERM displacement risk surfaces); NVDA Feynman first-CoPoS-adopter per Kuo analyst-T3. ETNews article itself = signal-amplifying with B40.1 partial-stale (Samsung "incumbent" framing stale for AI segment) + B40.2 timeline-inflation (article 2027 mass production contradicted by C.C. Wei T1-adjacent June 4 2026 "2-3 more years" → 2028-29 ramp consensus). Bear-case inversion REINFORCED: hybrid glass-core + ABF build-up architecture; ABF TAM EXPANDS. Per `signals/cross-source-log/2026-06-15-pm-tsmc-plp-etnews-2subagent-verification-tc5-cascade.md`. Prior: ABF/glass/ABF sandwich IEEE T1; TSMC CoPoS pilot completing June 2026; NEG 5214.T 515×510mm GC Core; Absolics/SKC end-2026 MP; Intel glass-core 2026-27. | 2026-06-15 PM Workflow #1 + Critical Rule #14 |
