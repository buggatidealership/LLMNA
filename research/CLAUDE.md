...
Predict → Grade (3-layer: INPUT / COMPUTATION / REASONING)
       ...
       → Principle (meta/methodology.md, currently #1-#47; candidates incl. #42 retrieval-staleness, #43 configuration-over-capability + #43b COMPUTE-INSTEAD-OF-NARRATE, #44 detection-over-prediction, #45 event-anchored-re-eval-dates 2026-07-14, #46 fluid-objective-function 2026-07-18, #47 verdicts-attach-to-distributions 2026-07-19)
       → Hook (deterministic Stop hook; count is COMPUTED — see meta/computed-counts.md, currently 21 script hooks wired in .claude/settings.json)
