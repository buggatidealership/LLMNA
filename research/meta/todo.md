...
- [ ] **P1 / research / 2026-07-07** [INDP, AF, BOT] — Build the APPLICATION/SOFTWARE-SERVICES-LAYER framework (the named blind spot)
  ...
  - Evidence rows verified w/ TRUE dates (07-07 brief gauntlet): Railway $100M Series B [2026-01-22 T1; ~2M devs, 31% F500, ARR >$10M]; Anthropic Cowork [preview 2026-01-12, GA Apr]; Slackbot-as-agent on Claude [GA 2026-01-13 T1, +30 features Mar-31]; GLM 5.2 pricing ~$4.40/M output (T2), "margin collapse" framing = T3 narrative. Per `2026-07-07-morning-brief-b61-gauntlet-kyber-skh-adr-applayer.md`.
