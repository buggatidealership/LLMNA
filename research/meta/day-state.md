...
**HOOK-PATCH PENDING USER APPROVAL:** sentinel session-start check blocked by permission classifier (correctly — self-modification gate); proposal at `meta/hooks/PROPOSED-w11-sentinel-patch.md`; interim detection = heartbeat step-1 + "wake audit" command.
