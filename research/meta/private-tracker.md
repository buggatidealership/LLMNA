...
- **2026-07-15 — FIRST MAINSTREAM-PRINT NORMALIZATION of the IPO plan:** WSJ issuance article states as background fact "the AI developer Anthropic and others planning to go public" (T1-publisher/background — NOT company-confirmed, no sourcing in-line, no timeline; consistent with the on-file confidential S-1 of 06-01). €50k-reserve read: the Principle #45 event anchor stays the PUBLIC S-1/pricing, not this backgrounder. Same article: SpaceX $75B June IPO biggest-ever; same day WSJ separately reports OpenAI IPO window "narrowing" (T2 headline, unpulled) + DeepSeek Shanghai IPO prep — the listed-lab comp set is forming on BOTH sides. Per `signals/cross-source-log/2026-07-15-wed-article-pulls-deepseek-funding-issuance-surge.md`.
- **2026-07-15 EVE — fab-allocation clarity (adversarial pass by-product, T2):** the FUNDED Broadcom-co-design line is fabbed at **TSMC N3/N2** (Broadcom holds TSMC 2nm/3nm capacity through end-decade; 1GW+ deployed 2027, ~3.5GW from 2027). The Samsung-2nm thread = a SEPARATE ground-up in-house chip (Clive Chan hire) and remains **TALKS ONLY** — the 07-15 KR "secured as 2nm customer" phrasing = verb-drift on the 07-02/03 The Information origin (kill of 07-14 RE-AFFIRMED; B40.x drift instance documented). Per `2026-07-15-wed-eve-samsung-tpu-io-die-dsp-cluster-2agent.md`.
...
- **2026-07-14 EVE — education-vertical usage truth (per `meta/education-ai-adoption-instrument.md`):** OpenAI's ChatGPT-for-Teachers 200K count UNREFRESHED 8 months (refresh-silence tell) while 900M WAU gets published eagerly; ChatGPT Edu = seat counts with ZERO published usage, and the **CSU renewal (~500K seats ≈ 70-75% of the US higher-ed headline, $17M) is expired-and-contested NOW** — a live binary on the biggest lab-edu deployment; 52% of CSU faculty say AI hurt teaching. Anthropic: Claude-for-Teachers offer DURATION still unverified (OpenAI's is T1 time-boxed to Jun-2027); free-to-paid conversion cliff = pre-registered event window H1-2027 for BOTH labs — first conversion disclosure anywhere is the missing demand-proof for the teacher-vertical segment (IPO-package contact: education channel currently all cost, no disclosed monetization).
- **2026-07-14 EVE — scaffolding-usage reading (per `meta/lab-scaffolding-usage-instrument.md`):** Claude Code >$2.5bn metered run-rate (T1 Feb-26) ≈ **~18% of ~$14bn ARR from ONE scaffold product** — the strongest dollar-weighted scaffold datum at any lab; Cowork task mix ~90% non-coding (T1-via-T2 Jul-7); ~4% of public GitHub commits (the only third-party-reproducible usage stat in the space). NON-DISCLOSURE map: Projects (nothing since Jun-24), Memory %, Skills invocations (circulating "Skills marketplace / 47% token reduction" stats = SEO-farm traceable, treat FABRICATED). **The S-1 public flip (~Aug-26) = the single biggest truth catalyst** — first audited decomposition; IPO-package linkage: pre-register reading the S-1's Claude Code/Cowork usage decomposition BEFORE any entry decision (B63-mandatory).
- **2026-07-14 EVE — MYTHOS-AS-BUDGET-DISRUPTOR (B63: Anthropic-negative externality, ingested full weight; per `signals/cross-source-log/2026-07-14-tue-ibm-warning-enterprise-memory-pullforward.md`):** IBM's Krishna cited "industry-wide cybersecurity concerns" in the Q2 warning; referent pinned = **Claude Mythos Preview** (found "thousands of high-severity zero-days... every major OS and browser," red.anthropic.com T1; N-day weaponization in hours by June, T2; CNBC "cybersecurity hysteria" May-8). **Krishna follow-up interview: "Mythos is making people pause to say, wait, how much do I need to spend on [cybersecurity]?" (T2 single-source — confirm at IBM's Jul-22 call).** New transmission channel beyond H2 trust-tax: Mythos-class capability is FREEZING/reprioritizing enterprise IT budgets economy-wide (secondary June referent: ShinyHunters wave, 721 ransomware victims). Barclays: bullish cyber names. IPO-package contact: cuts BOTH ways — capability moat demonstrated at civilization scale vs a named role in an enterprise-spending disruption narrative.
- **2026-07-14 EVE — Mythos cyber value-migration TESTED (per `wiki/ai-cybersecurity-value-migration.md`): the cyber angle is NOT a durable Anthropic moat.** Claude Security (500+ vulns, Opus 4.6) + Mythos are priced as PASS-THROUGH tokens ($25/$125 per Mtok via Bedrock/Vertex/Foundry, ~40 vetted Glasswing orgs), NOT a moated per-seat SKU — capability reaches enterprises THROUGH incumbents (PANW/CRWD/MSFT TAC partners), not around them. Finder=fixer symmetry refuted (discovery democratizing to 3.6B open models <1yr behind; fixing harder + deployment/liability-gated). Contradicts the H2-trust-tax-adjacent hope that cyber capability = enterprise lock-in. Watch (the falsifier that would REVIVE the bull): Anthropic launching a DIRECT enterprise security SKU with own MSA+indemnity+enforcement bypassing incumbents = attempted margin capture. None observed.

### DeepSeek
- **2026-07-15 EVE (The Information origin-verified, 1-agent):** ARR **$400–500M annualized API run-rate** (~2× 2025); **>50% GM on V4 inference** (compute-cost-only basis); **~2% of overseas usage monetized** (Sina CN). 2nd round = **~$1.5B new money at ~$71B ask via QFLP USD/Middle-East structure** (no LPs named) — mark-up event, not capital event (computed 20% of June round). June-round governance: **Liang-controlled LP, investors NO voting rights, 5-yr lock; state AI fund exempt** — control stays founder+state. Multiples (computed): 142–178× ARR at ask vs Anthropic 20.5× RRR. Burn rate NOT FOUND (paywall gap). Per `2026-07-15-wed-article-pulls-deepseek-funding-issuance-surge.md` §EVE ADDENDUM.
- **2026-07-15 (T1 WSJ article):** $7.4B maiden round @ >$50B (last month); raising again @ $71B+ ask; Shanghai IPO as early as Q2-2027, filing by end-2026; backers state-AI-fund/Tencent/CATL; ByteDance $20B AI loan talks same article. Per `2026-07-15-wed-article-pulls-deepseek-funding-issuance-surge.md`.

## 2026-07-17 — Lab margin reality + Moonshot (Kimi K3) entry (per `signals/cross-source-log/2026-07-17-fri-kimi-k3-open-vs-closed-baker-thesis-3agent.md`)
- **Margins (T2, The Information/SemiAnalysis via 3-agent verify):** Anthropic GM guided DOWN 60→47% (2025) / 63% (2026); inference costs +23% vs plan (Jan-26). OpenAI GM 40%→33%, missed 46% forecast; ~−$14B net 2026. SemiAnalysis: Anthropic blended mid-60s, API-only >80%. **"90% inference margins" = napkin-math rhetoric, no T1/T2 source — labs are missing guidance DOWNWARD.**
- **Moonshot AI:** Kimi K3 (Jul-16): 2.8T MoE / ~50B active, AA Idx 57 at $0.94/task (Pareto-frontier, token-inefficient 2× peer output volume); $3/$0.30/$15 pricing; weights GA ~Jul-27 (WATCH). Funding: $2B May-26 raise at >$20B on ~$200M ARR (>100× — strategic capital, not self-sustaining economics).
- **Vertical integration (dated):** OpenAI-Broadcom custom inference silicon 10GW-by-2029; Anthropic-Samsung SF2P 2nm custom-chip talks (TechCrunch Jul-02) + Google/Broadcom compute expansion; both labs pushing app-layer subsumption (super-app; Cowork/Marketplace).

- **2026-07-19 — Etched (transformer-inference ASIC):** TWO simultaneous unclosed rounds — Jane Street-led ~$20B valuation AND Sequoia-led ~$10B (WSJ-relay T2; $800M raised, ~$1B claimed orders TechCrunch Jun-30). The two-price structure = price-discovery failure at frontier-ASIC privates; 🔴 final print. TC-15 custom-silicon adjacency.
- **2026-07-19 — SpaceX-Pentagon compute talks** (WSJ/Bloomberg T2 Jul-17): DoD compute capacity, "billions," unclosed; defense = new non-hyperscaler compute-demand vector (TC-13 demand side). Agent-relayed per-month compute-deal figures (Google/Anthropic) UNVERIFIED — do not propagate.

- **2026-07-19 — WORLD-STATE UPDATE: SpaceX+xAI is PUBLIC (SPCX).** xAI acquired by SpaceX 2026-02-02 all-stock ($1.25T combined: SpaceX $1T + xAI $250B, CNBC); IPO'd Nasdaq 2026-06-12 at $135 raising $75B (largest IPO in history); ATH $225.64 Jun-16 → $123.99 Jul-18 (−45% from peak, below IPO). **Grok/xAI exposure is now LISTED-tape territory — but SPCX tape requires DECOMPOSITION before any AI read: the Jul-17 leg's driver was the Starship test-13 abort (4/33 Raptor-3 ignition failures), a rocket event not an AI event.** Per `2026-07-19-sun-eve-weisenthal-mooncake-sunday-3input-batch.md`.
- **2026-07-19 — Secondary marks: Anthropic implied $1.2T (Caplight) now ABOVE OpenAI $880B (Forge, ~3% over the $852B primary). BOTH ban SPVs** — Anthropic voids transfers, warned 8 platforms May-26 (TechCrunch T2); Sydecar secondary-SPV count +682% / capital +1,340% since 2023 (PitchBook-relay) = retail lab exposure is scaling AND partly legally void (unpriced tail). B64 disclosure: Anthropic = my model family's parent; figures third-party dated only.
- **2026-07-19 — Sunday Robotics (home robots, Memo):** $35M stealth (Benchmark/Conviction Nov-25) → $165M Series B @ $1.15B (Coatue lead, 2026-03-12, TechCrunch/Bloomberg T2); ACT-2 real-home eval program; onboard compute stack UNDISCLOSED (gap). Edge-inference convergence datum → TC-19 candidate.

## [2026-07-22] Batch updates (per `signals/cross-source-log/2026-07-22-wed-tue-catchup-14screenshot-batch.md`)
- **OpenRouter** — takeover interest at multibillion valuation (The Information Jul-21, SINGLE-ORIGINATOR, no buyer named; company silent). Canonical figures (garble-corrected, 2nd attempt): $113M Series B May-26 CapitalG-led at ~$1.3B post; ARR ~$50M (~Mar-26, Sacra); tokens ~25T/WEEK ≈ >1 quadrillion/yr pace (Menlo T2). The routing-layer monetization-vs-volume gap (~$50M ARR on quadrillion-scale tokens) = AGENTIC-DAU-relevant intensity-without-capture datum.
- **Anthropic** — REPORTED evaluating AMD MI450 as second source (ROCm hiring, T2/T3); Jefferies expects GW-level announcement at today's Advancing AI. B64 GUARD: expectation-tier only; adjudicate at keynote; two-branch pre-registration in `sector/competitive-map.md`.
- **Z.AI (Zhipu)** — 1GW datacenter running entirely on domestic chips, partial operation (Bloomberg Jul-20; chip mix reported-inferred T3, company silent). Sovereign-stack operating-capacity milestone; PC-20 N=5 tick.
