...
**Total fires (window 2026-06-15 → 2026-07-02 PM):** 135 (122 at wave-1 refresh + 9 post-wave-1 entries [123-131] + 4 enabling-layer map [132-135])
**Total estimated cost:** ~11.6M tokens (~11.2M at wave-1 refresh + ~200k post-wave-1 entries (est) + ~235k enabling-layer map [actual B 30.9k / C 62.3k / D 101.9k + A ~40k est]) — REVISED UPWARD per AM11 cost-model correction; backfill estimates were 12-18k/subagent which was 8-10× too low for deep verification fires. 30-day projection: ~15-22M tokens. **Note (per B58 codification today): "cost-budget warning" framing is bias-flagged per user directive depth-over-speed; this is informational audit-context, not decision-input.**
